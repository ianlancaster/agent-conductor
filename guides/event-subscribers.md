...
| `schedule`                  | `session`; `label`; immutable `scheduledAt`; scheduling `timezone`; `outcome: fired \| fired-fresh \| deferred-paused \| skipped-stopped \| skipped-cancelled \| failed \| uncertain` |
